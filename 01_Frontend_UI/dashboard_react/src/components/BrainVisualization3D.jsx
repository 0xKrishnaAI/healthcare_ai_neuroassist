...
export default function BrainVisualization3D({ brainRegions = {}, diagnosis = null, isLoading = false }) {
  ...
  const buildBrain = useCallback((scene) => {
    ...
    const cyanLight = new THREE.PointLight(0x00C6FF, 1.2, 20);
    cyanLight.position.set(5, 5, 5);
    scene.add(cyanLight);

    const purpleLight = new THREE.PointLight(0x7B2FBE, 0.8, 20);
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '480px', borderRadius: '16px', overflow: 'hidden', background: 'radial-gradient(ellipse at center, #0d2044 0%, #040d1a 100%)' }}>
